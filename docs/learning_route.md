...
本文档用于指导已经学习过 STM32 与 FreeRTOS 的同学，按当前项目代码逐步掌握 ESP32 + ESP-IDF 物联网网关项目，并完成独立调试与工程验收。
...
一周学习目标是达到“能理解运行流程、能说明关键设计、能完成基础调试”的程度，不要求完全掌握 ESP-IDF 全部底层实现。建议每天投入 3 到 5 小时。
...
如果以上内容能独立完成，就具备维护和继续扩展该 ESP32 + FreeRTOS 物联网工程的基础。
